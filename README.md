...
(Diagram w formie kodu napisany w programie Visual Studio Code oraz wygenerowany w formie graficznej w programie PlantUML zostanie dołączony w plikach diagram klas.puml, diagram klas.png)
